...
Реализация библиотеки string.h с дополнениями. Реализованы стандартные функции библиотеки string.h и добавлены дополнительные функции to_upper, to_lower,insert,trim. Также реализованы функции ввода из строки sscanf и вывода sprintf. Для всех функций написаны тесты с использованием библиотеки Check
### string.h Типы
